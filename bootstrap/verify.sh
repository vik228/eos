...
run_check "KB capture routing" "$ROOT/tests/test_kb_capture_routing.sh"
run_check "agent-run" "$ROOT/tests/test_agent_run.sh"
...
run_check "notebook reload protection E2E" "$ROOT/tests/test_nvim_notebook_reload_e2e.sh"
...
run_check "protected window routing" "$ROOT/tests/test_nvim_window_roles_e2e.sh"
run_check "WezTerm agent panes" "$ROOT/tests/test_nvim_agent_panes_e2e.sh"
