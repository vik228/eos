...
link_file "$HOME/.config/nvim/lua/config/agent_panes.lua" "$ROOT/configs/nvim/lua/config/agent_panes.lua"
...
link_file "$HOME/.config/nvim/lua/config/markdown_preview_style.json" "$ROOT/configs/nvim/lua/config/markdown_preview_style.json"
link_file "$HOME/.config/nvim/lua/config/notebook_sync.lua" "$ROOT/configs/nvim/lua/config/notebook_sync.lua"
link_file "$HOME/.config/nvim/lua/config/window_roles.lua" "$ROOT/configs/nvim/lua/config/window_roles.lua"
